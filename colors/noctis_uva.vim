...
call s:hi('Normal', '#c5c2d6', '#292640', '', '')
call s:hi('ColorColumn', '', '#473856', '', '')
call s:hi('Conceal', '#49ace9', '', '', '')
call s:hi('Cursor', '#292640', '#bbb3ff', '', '')
call s:hi('CursorColumn', '', '#342f58', '', '')
call s:hi('CursorLine', '', '#342f58', '', '')
call s:hi('CursorLineNr', '#7a70c2', '#342f58', '', 'bold')
call s:hi('Directory', '#49d6e9', '', '', '')
call s:hi('EndOfBuffer', '#292640', '#292640', '', '')
call s:hi('ErrorMsg', '#e34e1c', '#292640', '', 'bold')
call s:hi('FoldColumn', '#716c93', '#232136', '', '')
call s:hi('Folded', '#716c93', '#232136', '', 'italic')
call s:hi('IncSearch', '#292640', '#40bf6a', '', 'bold')
call s:hi('LineNr', '#5c5973', '#292640', '', '')
call s:hi('MatchParen', '#6e67a8', '#322f4e', '', 'bold')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold')
call s:hi('MoreMsg', '#49e9a6', '', '', '')
call s:hi('NonText', '#454259', '', '', '')
call s:hi('Pmenu', '#a9a5c0', '#2f2c49', '', '')
call s:hi('PmenuSbar', '', '#232136', '', '')
call s:hi('PmenuSel', '#c5c2d6', '#453f73', '', 'bold')
call s:hi('PmenuThumb', '', '#6e67a8', '', '')
call s:hi('Question', '#49e9a6', '', '', '')
call s:hi('QuickFixLine', '', '#1c4457', '', 'bold')
call s:hi('Search', '#c5c2d6', '#1c4457', '', '')
call s:hi('SignColumn', '#716c93', '#292640', '', '')
call s:hi('SpecialKey', '#454259', '', '', '')
...
call s:hi('StatusLine', '#998ef1', '#3e386a', '', 'bold')
call s:hi('StatusLineNC', '#8787ab', '#292640', '', '')
call s:hi('StatusLineTerm', '#998ef1', '#3e386a', '', 'bold')
call s:hi('StatusLineTermNC', '#8787ab', '#292640', '', '')
call s:hi('TabLine', '#a9a5c0', '#2f2c49', '', '')
call s:hi('TabLineFill', '', '#2f2c49', '', '')
call s:hi('TabLineSel', '#998ef1', '#292640', '', 'bold')
call s:hi('Title', '#49d6e9', '', '', 'bold')
call s:hi('VertSplit', '#171523', '#292640', '', '')
call s:hi('Visual', '', '#403c63', '', '')
call s:hi('VisualNOS', '', '#403c63', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#292640', '#6e67a8', '', 'bold')
call s:hi('WinSeparator', '#171523', '#292640', '', '')
call s:hi('Comment', '#716c93', '', '', 'italic')
...
call s:hi('Delimiter', '#c5c2d6', '', '', '')
call s:hi('SpecialComment', '#716c93', '', '', 'bold,italic')
call s:hi('Debug', '#e3541c', '', '', '')
call s:hi('Underlined', '#49ace9', '', '', 'underline')
call s:hi('Ignore', '#716c93', '', '', '')
call s:hi('Error', '#e34e1c', '#292640', '', 'bold')
call s:hi('Todo', '#292640', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#39454e', '', '')
call s:hi('DiffChange', '#ffc180', '#4b3f4a', '', '')
call s:hi('DiffDelete', '#e34e1c', '#472c3a', '', '')
call s:hi('DiffText', '#ffc180', '#655152', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#292640', '', '')
call s:hi('GitGutterChange', '#ffc180', '#292640', '', '')
call s:hi('GitGutterDelete', '#e34e1c', '#292640', '', '')
call s:hi('DiagnosticError', '#e34e1c', '', '', '')
call s:hi('DiagnosticWarn', '#e69533', '', '', '')
call s:hi('DiagnosticInfo', '#998ef1', '', '', '')
...
call s:hi('markdownHeadingRule', '#716c93', '', '', '')
