...
call s:hi('Normal', '#b2cacd', '#052529', '', '', '251', '234')
call s:hi('ColorColumn', '', '#29484c', '', '', '', '238')
call s:hi('Conceal', '#49ace9', '', '', '', '75', '')
call s:hi('Cursor', '#052529', '#85efff', '', '', '234', '123')
call s:hi('lCursor', '#052529', '#85efff', '', '', '234', '123')
call s:hi('CursorIM', '#052529', '#85efff', '', '', '234', '123')
call s:hi('CursorColumn', '', '#083b42', '', '', '', '236')
call s:hi('CursorLine', '', '#083b42', '', '', '', '236')
call s:hi('CursorLineNr', '#169fb1', '#083b42', '', 'bold', '38', '236')
call s:hi('CursorLineFold', '#169fb1', '#083b42', '', '', '38', '236')
call s:hi('CursorLineSign', '#169fb1', '#083b42', '', '', '38', '236')
call s:hi('Directory', '#49d6e9', '', '', '', '81', '')
call s:hi('EndOfBuffer', '#052529', '#052529', '', '', '234', '234')
call s:hi('ErrorMsg', '#e34e1c', '#052529', '', 'bold', '202', '234')
call s:hi('FoldColumn', '#5b858b', '#041d20', '', '', '67', '233')
call s:hi('Folded', '#5b858b', '#041d20', '', 'italic', '67', '233')
call s:hi('IncSearch', '#052529', '#40bf6a', '', 'bold', '234', '77')
call s:hi('LineNr', '#4e6b6e', '#052529', '', '', '241', '234')
call s:hi('MatchParen', '#169fb1', '#07353b', '', 'bold', '38', '235')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold', '85', '')
call s:hi('MoreMsg', '#49e9a6', '', '', '', '85', '')
call s:hi('NonText', '#254145', '', '', '', '237', '')
call s:hi('Pmenu', '#87a7ab', '#073940', '', '', '247', '235')
call s:hi('PmenuSbar', '', '#041d20', '', '', '', '233')
call s:hi('PmenuSel', '#b2cacd', '#0e6671', '', 'bold', '251', '23')
call s:hi('PmenuThumb', '', '#169fb1', '', '', '', '38')
call s:hi('Question', '#49e9a6', '', '', '', '85', '')
call s:hi('QuickFixLine', '', '#09444b', '', 'bold', '', '23')
call s:hi('Search', '#b2cacd', '#09444b', '', '', '251', '23')
call s:hi('SignColumn', '#5b858b', '#052529', '', '', '67', '234')
call s:hi('SpecialKey', '#254145', '', '', '', '237', '')
...
call s:hi('StatusLine', '#40d4e7', '#0a474f', '', 'bold', '81', '23')
call s:hi('StatusLineNC', '#87a7ab', '#041d20', '', '', '247', '233')
call s:hi('StatusLineTerm', '#40d4e7', '#0a474f', '', 'bold', '81', '23')
call s:hi('StatusLineTermNC', '#87a7ab', '#041d20', '', '', '247', '233')
call s:hi('TabLine', '#87a7ab', '#062e32', '', '', '247', '235')
call s:hi('TabLineFill', '', '#062e32', '', '', '', '235')
call s:hi('TabLineSel', '#40d4e7', '#052529', '', 'bold', '81', '234')
call s:hi('Title', '#49d6e9', '', '', 'bold', '81', '')
call s:hi('VertSplit', '#0f1415', '#052529', '', '', '233', '234')
call s:hi('Visual', '', '#0a464d', '', '', '', '23')
call s:hi('VisualNOS', '', '#0a464d', '', '', '', '23')
call s:hi('WarningMsg', '#e69533', '', '', 'bold', '215', '')
call s:hi('WildMenu', '#052529', '#169fb1', '', 'bold', '234', '38')
call s:hi('WinSeparator', '#0f1415', '#052529', '', '', '233', '234')
...
call s:hi('Error', '#e34e1c', '#052529', '', 'bold', '202', '234')
call s:hi('Todo', '#052529', '#e69533', '', 'bold', '234', '215')
call s:hi('DiffAdd', '#8ce99a', '#1b443b', '', '', '157', '236')
call s:hi('DiffChange', '#e0c184', '#283e38', '', '', '222', '236')
call s:hi('DiffDelete', '#e34e1c', '#292c27', '', '', '202', '235')
call s:hi('DiffText', '#e0c184', '#425142', '', 'bold', '222', '238')
call s:hi('GitGutterAdd', '#8ce99a', '#052529', '', '', '157', '234')
call s:hi('GitGutterChange', '#e0c184', '#052529', '', '', '222', '234')
call s:hi('GitGutterDelete', '#e34e1c', '#052529', '', '', '202', '234')
call s:hi('TermCursor', '#052529', '#85efff', '', '', '234', '123')
call s:hi('TermCursorNC', '#083d44', '#083b42', '', '', '23', '236')
