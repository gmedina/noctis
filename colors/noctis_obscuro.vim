...
call s:hi('Normal', '#b2cacd', '#031417', '', '')
call s:hi('ColorColumn', '', '#243f42', '', '')
call s:hi('Conceal', '#49ace9', '', '', '')
call s:hi('Cursor', '#031417', '#85efff', '', '')
call s:hi('CursorColumn', '', '#083a41', '', '')
call s:hi('CursorLine', '', '#083a41', '', '')
call s:hi('CursorLineNr', '#169fb1', '#083a41', '', 'bold')
call s:hi('Directory', '#49d6e9', '', '', '')
call s:hi('EndOfBuffer', '#031417', '#031417', '', '')
call s:hi('ErrorMsg', '#e34e1c', '#031417', '', 'bold')
call s:hi('FoldColumn', '#5b858b', '#021012', '', '')
call s:hi('Folded', '#5b858b', '#021012', '', 'italic')
call s:hi('IncSearch', '#031417', '#40bf6a', '', 'bold')
call s:hi('LineNr', '#4e6b6e', '#031417', '', '')
call s:hi('MatchParen', '#169fb1', '#06272c', '', 'bold')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold')
call s:hi('MoreMsg', '#49e9a6', '', '', '')
call s:hi('NonText', '#243235', '', '', '')
call s:hi('Pmenu', '#87a7ab', '#062e32', '', '')
call s:hi('PmenuSbar', '', '#021012', '', '')
call s:hi('PmenuSel', '#b2cacd', '#0e6671', '', 'bold')
call s:hi('PmenuThumb', '', '#169fb1', '', '')
call s:hi('Question', '#49e9a6', '', '', '')
call s:hi('QuickFixLine', '', '#083b42', '', 'bold')
call s:hi('Search', '#b2cacd', '#083b42', '', '')
call s:hi('SignColumn', '#5b858b', '#031417', '', '')
call s:hi('SpecialKey', '#243235', '', '', '')
...
call s:hi('StatusLine', '#ebfdff', '#094148', '', 'bold')
call s:hi('StatusLineNC', '#87a7ab', '#031417', '', '')
call s:hi('StatusLineTerm', '#ebfdff', '#094148', '', 'bold')
call s:hi('StatusLineTermNC', '#87a7ab', '#031417', '', '')
call s:hi('TabLine', '#87a7ab', '#062e32', '', '')
call s:hi('TabLineFill', '', '#062e32', '', '')
call s:hi('TabLineSel', '#ebfdff', '#031417', '', 'bold')
call s:hi('Title', '#49d6e9', '', '', 'bold')
call s:hi('VertSplit', '#0f1415', '#031417', '', '')
call s:hi('Visual', '', '#083940', '', '')
call s:hi('VisualNOS', '', '#083940', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#031417', '#169fb1', '', 'bold')
call s:hi('WinSeparator', '#0f1415', '#031417', '', '')
...
call s:hi('Error', '#e34e1c', '#031417', '', 'bold')
call s:hi('Todo', '#031417', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#19362c', '', '')
call s:hi('DiffChange', '#e4b781', '#272e28', '', '')
call s:hi('DiffDelete', '#e34e1c', '#271d18', '', '')
call s:hi('DiffText', '#e4b781', '#424235', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#031417', '', '')
call s:hi('GitGutterChange', '#e4b781', '#031417', '', '')
call s:hi('GitGutterDelete', '#e34e1c', '#031417', '', '')
