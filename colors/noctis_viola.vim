...
call s:hi('Normal', '#ccbfd9', '#30243d', '', '')
call s:hi('ColorColumn', '', '#473856', '', '')
call s:hi('Conceal', '#49ace9', '', '', '')
call s:hi('Cursor', '#30243d', '#d9b3ff', '', '')
call s:hi('CursorColumn', '', '#3f2c52', '', '')
call s:hi('CursorLine', '', '#3f2c52', '', '')
call s:hi('CursorLineNr', '#996bc7', '#3f2c52', '', 'bold')
call s:hi('Directory', '#49d6e9', '', '', '')
call s:hi('EndOfBuffer', '#30243d', '#30243d', '', '')
call s:hi('ErrorMsg', '#e34e1c', '#30243d', '', 'bold')
call s:hi('FoldColumn', '#7f659a', '#2b2136', '', '')
call s:hi('Folded', '#7f659a', '#2b2136', '', 'italic')
call s:hi('IncSearch', '#30243d', '#40bf6a', '', 'bold')
call s:hi('LineNr', '#665973', '#30243d', '', '')
call s:hi('MatchParen', '#8767a8', '#3c2d4b', '', 'bold')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold')
call s:hi('MoreMsg', '#49e9a6', '', '', '')
call s:hi('NonText', '#4b4056', '', '', '')
call s:hi('Pmenu', '#b3a5c0', '#3d2e4d', '', '')
call s:hi('PmenuSbar', '', '#2b2136', '', '')
call s:hi('PmenuSel', '#ccbfd9', '#593a78', '', 'bold')
call s:hi('PmenuThumb', '', '#8767a8', '', '')
call s:hi('Question', '#49e9a6', '', '', '')
call s:hi('QuickFixLine', '', '#204356', '', 'bold')
call s:hi('Search', '#ccbfd9', '#204356', '', '')
call s:hi('SignColumn', '#7f659a', '#30243d', '', '')
call s:hi('SpecialKey', '#4b4056', '', '', '')
...
call s:hi('StatusLine', '#bf8ef1', '#54396f', '', 'bold')
call s:hi('StatusLineNC', '#9987ab', '#30243d', '', '')
call s:hi('StatusLineTerm', '#bf8ef1', '#54396f', '', 'bold')
call s:hi('StatusLineTermNC', '#9987ab', '#30243d', '', '')
call s:hi('TabLine', '#b3a5c0', '#3d2e4d', '', '')
call s:hi('TabLineFill', '', '#3d2e4d', '', '')
call s:hi('TabLineSel', '#bf8ef1', '#30243d', '', 'bold')
call s:hi('Title', '#49d6e9', '', '', 'bold')
call s:hi('VertSplit', '#1c1226', '#30243d', '', '')
call s:hi('Visual', '', '#4d3a61', '', '')
call s:hi('VisualNOS', '', '#4d3a61', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#30243d', '#8767a8', '', 'bold')
call s:hi('WinSeparator', '#1c1226', '#30243d', '', '')
call s:hi('Comment', '#7f659a', '', '', 'italic')
...
call s:hi('Delimiter', '#ccbfd9', '', '', '')
call s:hi('SpecialComment', '#7f659a', '', '', 'bold,italic')
call s:hi('Debug', '#e3541c', '', '', '')
call s:hi('Underlined', '#49ace9', '', '', 'underline')
call s:hi('Ignore', '#7f659a', '', '', '')
call s:hi('Error', '#e34e1c', '#30243d', '', 'bold')
call s:hi('Todo', '#30243d', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#3f444c', '', '')
call s:hi('DiffChange', '#ffc180', '#513d48', '', '')
call s:hi('DiffDelete', '#e34e1c', '#4d2b38', '', '')
call s:hi('DiffText', '#ffc180', '#6a5050', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#30243d', '', '')
call s:hi('GitGutterChange', '#ffc180', '#30243d', '', '')
call s:hi('GitGutterDelete', '#e34e1c', '#30243d', '', '')
call s:hi('DiagnosticError', '#e34e1c', '', '', '')
call s:hi('DiagnosticWarn', '#e69533', '', '', '')
call s:hi('DiagnosticInfo', '#bf8ef1', '', '', '')
...
call s:hi('markdownHeadingRule', '#7f659a', '', '', '')
