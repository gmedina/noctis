...
call s:hi('Normal', '#005661', '#f4f6f6', '', '')
call s:hi('ColorColumn', '', '#d0edf1', '', '')
call s:hi('Conceal', '#0094f0', '', '', '')
call s:hi('Cursor', '#f4f6f6', '#0092a8', '', '')
call s:hi('CursorColumn', '', '#d8edf0', '', '')
call s:hi('CursorLine', '', '#d8edf0', '', '')
call s:hi('CursorLineNr', '#0099ad', '#d8edf0', '', 'bold')
call s:hi('Directory', '#00bdd6', '', '', '')
call s:hi('EndOfBuffer', '#f4f6f6', '#f4f6f6', '', '')
call s:hi('ErrorMsg', '#ff4000', '#f4f6f6', '', 'bold')
call s:hi('FoldColumn', '#8ca6a6', '#e7f2f3', '', '')
call s:hi('Folded', '#8ca6a6', '#e7f2f3', '', 'italic')
call s:hi('IncSearch', '#f4f6f6', '#8ce99a', '', 'bold')
call s:hi('LineNr', '#a0abac', '#f4f6f6', '', '')
call s:hi('MatchParen', '#0099ad', '#d5eaed', '', 'bold')
call s:hi('ModeMsg', '#00b368', '', '', 'bold')
call s:hi('MoreMsg', '#00b368', '', '', '')
call s:hi('NonText', '#cfdddf', '', '', '')
call s:hi('Pmenu', '#6a7a7c', '#e0eff1', '', '')
call s:hi('PmenuSbar', '', '#e7f2f3', '', '')
call s:hi('PmenuSel', '#005661', '#bbe0f7', '', 'bold')
call s:hi('PmenuThumb', '', '#0099ad', '', '')
call s:hi('Question', '#00b368', '', '', '')
call s:hi('QuickFixLine', '', '#c7e1e5', '', 'bold')
call s:hi('Search', '#005661', '#c7e1e5', '', '')
call s:hi('SignColumn', '#8ca6a6', '#f4f6f6', '', '')
call s:hi('SpecialKey', '#cfdddf', '', '', '')
...
call s:hi('StatusLine', '#0099ad', '#dfeff1', '', 'bold')
call s:hi('StatusLineNC', '#87a7ab', '#caedf2', '', '')
call s:hi('StatusLineTerm', '#0099ad', '#dfeff1', '', 'bold')
call s:hi('StatusLineTermNC', '#87a7ab', '#caedf2', '', '')
call s:hi('TabLine', '#71838e', '#caedf2', '', '')
call s:hi('TabLineFill', '', '#caedf2', '', '')
call s:hi('TabLineSel', '#0099ad', '#f4f6f6', '', 'bold')
call s:hi('Title', '#00bdd6', '', '', 'bold')
call s:hi('VertSplit', '#ece2c6', '#f4f6f6', '', '')
call s:hi('Visual', '', '#d3edf1', '', '')
call s:hi('VisualNOS', '', '#d3edf1', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#f4f6f6', '#0099ad', '', 'bold')
call s:hi('WinSeparator', '#ece2c6', '#f4f6f6', '', '')
call s:hi('Comment', '#8ca6a6', '', '', 'italic')
...
call s:hi('Delimiter', '#004d57', '', '', '')
call s:hi('SpecialComment', '#8ca6a6', '', '', 'bold,italic')
call s:hi('Debug', '#ff530f', '', '', '')
call s:hi('Underlined', '#0094f0', '', '', 'underline')
call s:hi('Ignore', '#8ca6a6', '', '', '')
call s:hi('Error', '#ff4000', '#f4f6f6', '', 'bold')
call s:hi('Todo', '#f4f6f6', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#e3f4e7', '', '')
call s:hi('DiffChange', '#e9a149', '#f2e8da', '', '')
call s:hi('DiffDelete', '#ff4000', '#f6d9cf', '', '')
call s:hi('DiffText', '#e9a149', '#f1dec6', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#f4f6f6', '', '')
call s:hi('GitGutterChange', '#e9a149', '#f4f6f6', '', '')
call s:hi('GitGutterDelete', '#ff4000', '#f4f6f6', '', '')
...
call s:hi('markdownHeadingRule', '#8ca6a6', '', '', '')
