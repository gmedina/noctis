...
call s:hi('Normal', '#005661', '#fef8ec', '', '')
call s:hi('ColorColumn', '', '#f1e6d0', '', '')
call s:hi('Conceal', '#0094f0', '', '', '')
call s:hi('Cursor', '#fef8ec', '#0092a8', '', '')
call s:hi('CursorColumn', '', '#daeeee', '', '')
call s:hi('CursorLine', '', '#daeeee', '', '')
call s:hi('CursorLineNr', '#0099ad', '#daeeee', '', 'bold')
call s:hi('Directory', '#00bdd6', '', '', '')
call s:hi('EndOfBuffer', '#fef8ec', '#fef8ec', '', '')
call s:hi('ErrorMsg', '#ff4000', '#fef8ec', '', 'bold')
call s:hi('FoldColumn', '#8ca6a6', '#f9f1e1', '', '')
call s:hi('Folded', '#8ca6a6', '#f9f1e1', '', 'italic')
call s:hi('IncSearch', '#fef8ec', '#8ce99a', '', 'bold')
call s:hi('LineNr', '#a0abac', '#fef8ec', '', '')
call s:hi('MatchParen', '#0099ad', '#deece4', '', 'bold')
call s:hi('ModeMsg', '#00b368', '', '', 'bold')
call s:hi('MoreMsg', '#00b368', '', '', '')
call s:hi('NonText', '#ded9cf', '', '', '')
call s:hi('Pmenu', '#6a7a7c', '#f2edde', '', '')
call s:hi('PmenuSbar', '', '#f9f1e1', '', '')
call s:hi('PmenuSel', '#005661', '#dbfaff', '', 'bold')
call s:hi('PmenuThumb', '', '#0099ad', '', '')
call s:hi('Question', '#00b368', '', '', '')
call s:hi('QuickFixLine', '', '#cfe3dd', '', 'bold')
call s:hi('Search', '#005661', '#cfe3dd', '', '')
call s:hi('SignColumn', '#8ca6a6', '#fef8ec', '', '')
call s:hi('SpecialKey', '#ded9cf', '', '', '')
...
call s:hi('StatusLineNC', '#87a7ab', '#f0e9d6', '', '')
call s:hi('StatusLineTerm', '#0099ad', '#dfeff1', '', 'bold')
call s:hi('StatusLineTermNC', '#87a7ab', '#f0e9d6', '', '')
call s:hi('TabLine', '#888477', '#f0e9d6', '', '')
call s:hi('TabLineFill', '', '#f0e9d6', '', '')
call s:hi('TabLineSel', '#0099ad', '#fef8ec', '', 'bold')
call s:hi('Title', '#00bdd6', '', '', 'bold')
call s:hi('VertSplit', '#ece2c6', '#fef8ec', '', '')
call s:hi('Visual', '', '#d8eeec', '', '')
call s:hi('VisualNOS', '', '#d8eeec', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#fef8ec', '#0099ad', '', 'bold')
call s:hi('WinSeparator', '#ece2c6', '#fef8ec', '', '')
...
call s:hi('Error', '#ff4000', '#fef8ec', '', 'bold')
call s:hi('Todo', '#fef8ec', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#ecf6df', '', '')
call s:hi('DiffChange', '#e9a149', '#fbead2', '', '')
call s:hi('DiffDelete', '#ff4000', '#fedbc6', '', '')
call s:hi('DiffText', '#e9a149', '#f8e0be', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#fef8ec', '', '')
call s:hi('GitGutterChange', '#e9a149', '#fef8ec', '', '')
call s:hi('GitGutterDelete', '#ff4000', '#fef8ec', '', '')
