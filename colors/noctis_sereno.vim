...
call s:hi('Normal', '#b2cacd', '#062e32', '', '', '251', '235')
call s:hi('ColorColumn', '', '#29484c', '', '', '', '238')
call s:hi('Conceal', '#49ace9', '', '', '', '75', '')
call s:hi('Cursor', '#062e32', '#85efff', '', '', '235', '123')
call s:hi('lCursor', '#062e32', '#85efff', '', '', '235', '123')
call s:hi('CursorIM', '#062e32', '#85efff', '', '', '235', '123')
call s:hi('CursorColumn', '', '#083c43', '', '', '', '23')
call s:hi('CursorLine', '', '#083c43', '', '', '', '23')
call s:hi('CursorLineNr', '#169fb1', '#083c43', '', 'bold', '38', '23')
call s:hi('CursorLineFold', '#169fb1', '#083c43', '', '', '38', '23')
call s:hi('CursorLineSign', '#169fb1', '#083c43', '', '', '38', '23')
call s:hi('Directory', '#49d6e9', '', '', '', '81', '')
call s:hi('EndOfBuffer', '#062e32', '#062e32', '', '', '235', '235')
call s:hi('ErrorMsg', '#e34e1c', '#062e32', '', 'bold', '202', '235')
call s:hi('FoldColumn', '#5b858b', '#052629', '', '', '67', '234')
call s:hi('Folded', '#5b858b', '#052629', '', 'italic', '67', '234')
call s:hi('IncSearch', '#062e32', '#40bf6a', '', 'bold', '235', '77')
call s:hi('LineNr', '#4e6b6e', '#062e32', '', '', '241', '235')
call s:hi('MatchParen', '#169fb1', '#083d43', '', 'bold', '38', '23')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold', '85', '')
call s:hi('MoreMsg', '#49e9a6', '', '', '', '85', '')
call s:hi('NonText', '#26494d', '', '', '', '237', '')
call s:hi('Pmenu', '#87a7ab', '#083d44', '', '', '247', '23')
call s:hi('PmenuSbar', '', '#052629', '', '', '', '234')
call s:hi('PmenuSel', '#b2cacd', '#0e6671', '', 'bold', '251', '23')
call s:hi('PmenuThumb', '', '#169fb1', '', '', '', '38')
call s:hi('Question', '#49e9a6', '', '', '', '85', '')
call s:hi('QuickFixLine', '', '#0a4950', '', 'bold', '', '23')
call s:hi('Search', '#b2cacd', '#0a4950', '', '', '251', '23')
call s:hi('SignColumn', '#5b858b', '#062e32', '', '', '67', '235')
call s:hi('SpecialKey', '#26494d', '', '', '', '237', '')
...
call s:hi('StatusLine', '#40d4e7', '#0a4e55', '', 'bold', '81', '23')
call s:hi('StatusLineNC', '#87a7ab', '#052629', '', '', '247', '234')
call s:hi('StatusLineTerm', '#40d4e7', '#0a4e55', '', 'bold', '81', '23')
call s:hi('StatusLineTermNC', '#87a7ab', '#052629', '', '', '247', '234')
call s:hi('TabLine', '#87a7ab', '#062e32', '', '', '247', '235')
call s:hi('TabLineFill', '', '#062e32', '', '', '', '235')
call s:hi('TabLineSel', '#40d4e7', '#062e32', '', 'bold', '81', '235')
call s:hi('Title', '#49d6e9', '', '', 'bold', '81', '')
call s:hi('VertSplit', '#0f1415', '#062e32', '', '', '233', '235')
call s:hi('Visual', '', '#0a4c54', '', '', '', '23')
call s:hi('VisualNOS', '', '#0a4c54', '', '', '', '23')
call s:hi('WarningMsg', '#e69533', '', '', 'bold', '215', '')
call s:hi('WildMenu', '#062e32', '#169fb1', '', 'bold', '235', '38')
call s:hi('WinSeparator', '#0f1415', '#062e32', '', '', '233', '235')
...
call s:hi('Error', '#e34e1c', '#062e32', '', 'bold', '202', '235')
call s:hi('Todo', '#062e32', '#e69533', '', 'bold', '235', '215')
call s:hi('DiffAdd', '#8ce99a', '#1b4c43', '', '', '157', '237')
call s:hi('DiffChange', '#e0c184', '#29463f', '', '', '222', '237')
call s:hi('DiffDelete', '#e34e1c', '#29332e', '', '', '202', '236')
call s:hi('DiffText', '#e0c184', '#435749', '', 'bold', '222', '239')
call s:hi('GitGutterAdd', '#8ce99a', '#062e32', '', '', '157', '235')
call s:hi('GitGutterChange', '#e0c184', '#062e32', '', '', '222', '235')
call s:hi('GitGutterDelete', '#e34e1c', '#062e32', '', '', '202', '235')
call s:hi('TermCursor', '#062e32', '#85efff', '', '', '235', '123')
call s:hi('TermCursorNC', '#083d44', '#083c43', '', '', '23', '23')
