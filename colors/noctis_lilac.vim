...
call s:hi('Normal', '#0c006b', '#f2f1f8', '', '', '17', '255')
call s:hi('ColorColumn', '', '#d4d0f1', '', '', '', '189')
call s:hi('Conceal', '#0094f0', '', '', '', '39', '')
call s:hi('Cursor', '#f2f1f8', '#5c49e9', '', '', '255', '63')
call s:hi('lCursor', '#f2f1f8', '#5c49e9', '', '', '255', '63')
call s:hi('CursorIM', '#f2f1f8', '#5c49e9', '', '', '255', '63')
call s:hi('CursorColumn', '', '#e1def3', '', '', '', '254')
call s:hi('CursorLine', '', '#e1def3', '', '', '', '254')
call s:hi('CursorLineNr', '#7060eb', '#e1def3', '', 'bold', '63', '254')
call s:hi('CursorLineFold', '#7060eb', '#e1def3', '', '', '63', '254')
call s:hi('CursorLineSign', '#7060eb', '#e1def3', '', '', '63', '254')
call s:hi('Directory', '#00bdd6', '', '', '', '44', '')
call s:hi('EndOfBuffer', '#f2f1f8', '#f2f1f8', '', '', '255', '255')
call s:hi('ErrorMsg', '#ff4000', '#f2f1f8', '', 'bold', '202', '255')
call s:hi('FoldColumn', '#9995b7', '#edecf8', '', '', '247', '255')
call s:hi('Folded', '#9995b7', '#edecf8', '', 'italic', '247', '255')
call s:hi('IncSearch', '#f2f1f8', '#8ce99a', '', 'bold', '255', '157')
call s:hi('LineNr', '#9d9ab1', '#f2f1f8', '', '', '247', '255')
call s:hi('MatchParen', '#7060eb', '#e2dff6', '', 'bold', '63', '254')
call s:hi('ModeMsg', '#00b368', '', '', 'bold', '41', '')
call s:hi('MoreMsg', '#00b368', '', '', '', '41', '')
call s:hi('NonText', '#d0cee0', '', '', '', '252', '')
call s:hi('Pmenu', '#666284', '#dedbf5', '', '', '60', '254')
call s:hi('PmenuSbar', '', '#edecf8', '', '', '', '255')
call s:hi('PmenuSel', '#0c006b', '#cac4f3', '', 'bold', '17', '189')
call s:hi('PmenuThumb', '', '#7060eb', '', '', '', '63')
call s:hi('Question', '#00b368', '', '', '', '41', '')
call s:hi('QuickFixLine', '', '#c6dde6', '', 'bold', '', '253')
call s:hi('Search', '#0c006b', '#c6dde6', '', '', '17', '253')
call s:hi('SignColumn', '#9995b7', '#f2f1f8', '', '', '247', '255')
call s:hi('SpecialKey', '#d0cee0', '', '', '', '252', '')
...
call s:hi('StatusLine', '#7060eb', '#c1bbec', '', 'bold', '63', '252')
call s:hi('StatusLineNC', '#8b87ab', '#e2dff6', '', '', '246', '254')
call s:hi('StatusLineTerm', '#7060eb', '#c1bbec', '', 'bold', '63', '252')
call s:hi('StatusLineTermNC', '#8b87ab', '#e2dff6', '', '', '246', '254')
call s:hi('TabLine', '#75718e', '#e2dff6', '', '', '244', '254')
call s:hi('TabLineFill', '', '#e2dff6', '', '', '', '254')
call s:hi('TabLineSel', '#7060eb', '#f2f1f8', '', 'bold', '63', '255')
call s:hi('Title', '#00bdd6', '', '', 'bold', '44', '')
call s:hi('VertSplit', '#ece2c6', '#f2f1f8', '', '', '253', '255')
call s:hi('Visual', '', '#d5d1f2', '', '', '', '189')
call s:hi('VisualNOS', '', '#d5d1f2', '', '', '', '189')
call s:hi('WarningMsg', '#e69533', '', '', 'bold', '215', '')
call s:hi('WildMenu', '#f2f1f8', '#7060eb', '', 'bold', '255', '63')
call s:hi('WinSeparator', '#ece2c6', '#f2f1f8', '', '', '253', '255')
call s:hi('Comment', '#9995b7', '', '', 'italic', '247', '')
...
call s:hi('Delimiter', '#0c006b', '', '', '', '17', '')
call s:hi('SpecialComment', '#9995b7', '', '', 'bold,italic', '247', '')
call s:hi('Debug', '#ff530f', '', '', '', '202', '')
call s:hi('Underlined', '#0094f0', '', '', 'underline', '39', '')
call s:hi('Ignore', '#9995b7', '', '', '', '247', '')
call s:hi('Error', '#ff4000', '#f2f1f8', '', 'bold', '202', '255')
call s:hi('Todo', '#f2f1f8', '#e69533', '', 'bold', '255', '215')
call s:hi('DiffAdd', '#8ce99a', '#e2f0e9', '', '', '157', '255')
call s:hi('DiffChange', '#e9a149', '#f1e4dc', '', '', '215', '254')
call s:hi('DiffDelete', '#ff4000', '#f4d5d0', '', '', '202', '224')
call s:hi('DiffText', '#e9a149', '#efdbc7', '', 'bold', '215', '253')
call s:hi('GitGutterAdd', '#8ce99a', '#f2f1f8', '', '', '157', '255')
call s:hi('GitGutterChange', '#e9a149', '#f2f1f8', '', '', '215', '255')
call s:hi('GitGutterDelete', '#ff4000', '#f2f1f8', '', '', '202', '255')
call s:hi('TermCursor', '#f2f1f8', '#5c49e9', '', '', '255', '63')
call s:hi('TermCursorNC', '#f2f1f8', '#e1def3', '', '', '255', '254')
...
call s:hi('markdownHeadingRule', '#9995b7', '', '', '', '247', '')
