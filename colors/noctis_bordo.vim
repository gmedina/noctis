...
let g:colors_name = 'noctis_bordo'
set background=dark
...
let s:terminal_ansi_colors = ['#47393e','#e66533','#49e9a6','#e4b781','#49ace9','#df769b','#49d6e9','#b9acb0','#69545b','#e97749','#60ebb1','#e69533','#60b6eb','#e798b3','#60dbeb','#cbbec2']
if has('nvim')
...
call s:hi('Normal', '#cbbec2', '#322a2d', '', '', '251', '236')
call s:hi('ColorColumn', '', '#593a46', '', '', '', '238')
call s:hi('Conceal', '#49ace9', '', '', '', '75', '')
call s:hi('Cursor', '#322a2d', '#ffb3cd', '', '', '236', '224')
call s:hi('lCursor', '#322a2d', '#ffb3cd', '', '', '236', '224')
call s:hi('CursorIM', '#322a2d', '#ffb3cd', '', '', '236', '224')
call s:hi('CursorColumn', '', '#3f2f34', '', '', '', '237')
call s:hi('CursorLine', '', '#3f2f34', '', '', '', '237')
call s:hi('CursorLineNr', '#bb778f', '#3f2f34', '', 'bold', '175', '237')
call s:hi('CursorLineFold', '#bb778f', '#3f2f34', '', '', '175', '237')
call s:hi('CursorLineSign', '#bb778f', '#3f2f34', '', '', '175', '237')
call s:hi('Directory', '#49d6e9', '', '', '', '81', '')
call s:hi('EndOfBuffer', '#322a2d', '#322a2d', '', '', '236', '236')
call s:hi('ErrorMsg', '#e34e1c', '#322a2d', '', 'bold', '202', '236')
call s:hi('FoldColumn', '#8b747c', '#2c2528', '', '', '244', '235')
call s:hi('Folded', '#8b747c', '#2c2528', '', 'italic', '244', '235')
call s:hi('IncSearch', '#322a2d', '#40bf6a', '', 'bold', '236', '77')
call s:hi('LineNr', '#715b63', '#322a2d', '', '', '241', '236')
call s:hi('MatchParen', '#997582', '#403438', '', 'bold', '245', '237')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold', '85', '')
call s:hi('MoreMsg', '#49e9a6', '', '', '', '85', '')
call s:hi('NonText', '#4d3f44', '', '', '', '238', '')
call s:hi('Pmenu', '#bbaab0', '#413036', '', '', '249', '237')
call s:hi('PmenuSbar', '', '#2c2528', '', '', '', '235')
call s:hi('PmenuSel', '#cbbec2', '#563440', '', 'bold', '251', '238')
call s:hi('PmenuThumb', '', '#997582', '', '', '', '245')
call s:hi('Question', '#49e9a6', '', '', '', '85', '')
call s:hi('QuickFixLine', '', '#21464d', '', 'bold', '', '237')
call s:hi('Search', '#cbbec2', '#21464d', '', '', '251', '237')
call s:hi('SignColumn', '#8b747c', '#322a2d', '', '', '244', '236')
call s:hi('SpecialKey', '#4d3f44', '', '', '', '238', '')
...
call s:hi('StatusLine', '#f18eb0', '#5d3f49', '', 'bold', '218', '239')
call s:hi('StatusLineNC', '#a48e96', '#322a2d', '', '', '246', '236')
call s:hi('StatusLineTerm', '#f18eb0', '#5d3f49', '', 'bold', '218', '239')
call s:hi('StatusLineTermNC', '#a48e96', '#322a2d', '', '', '246', '236')
call s:hi('TabLine', '#bbaab0', '#413036', '', '', '249', '237')
call s:hi('TabLineFill', '', '#413036', '', '', '', '237')
call s:hi('TabLineSel', '#f18eb0', '#322a2d', '', 'bold', '218', '236')
call s:hi('Title', '#49d6e9', '', '', 'bold', '81', '')
call s:hi('VertSplit', '#1f191b', '#322a2d', '', '', '234', '236')
call s:hi('Visual', '', '#544349', '', '', '', '239')
call s:hi('VisualNOS', '', '#544349', '', '', '', '239')
call s:hi('WarningMsg', '#e69533', '', '', 'bold', '215', '')
call s:hi('WildMenu', '#322a2d', '#997582', '', 'bold', '236', '245')
call s:hi('WinSeparator', '#1f191b', '#322a2d', '', '', '234', '236')
call s:hi('Comment', '#8b747c', '', '', 'italic', '244', '')
...
call s:hi('Delimiter', '#cbbec2', '', '', '', '251', '')
call s:hi('SpecialComment', '#8b747c', '', '', 'bold,italic', '244', '')
call s:hi('Debug', '#e3541c', '', '', '', '202', '')
call s:hi('Underlined', '#49ace9', '', '', 'underline', '75', '')
call s:hi('Ignore', '#8b747c', '', '', '', '244', '')
call s:hi('Error', '#e34e1c', '#322a2d', '', 'bold', '202', '236')
call s:hi('Todo', '#322a2d', '#e69533', '', 'bold', '236', '215')
call s:hi('DiffAdd', '#8ce99a', '#40493e', '', '', '157', '238')
call s:hi('DiffChange', '#ffc180', '#53423a', '', '', '222', '238')
call s:hi('DiffDelete', '#e34e1c', '#4e302a', '', '', '202', '237')
call s:hi('DiffText', '#ffc180', '#6b5444', '', 'bold', '222', '240')
call s:hi('GitGutterAdd', '#8ce99a', '#322a2d', '', '', '157', '236')
call s:hi('GitGutterChange', '#ffc180', '#322a2d', '', '', '222', '236')
call s:hi('GitGutterDelete', '#e34e1c', '#322a2d', '', '', '202', '236')
call s:hi('TermCursor', '#322a2d', '#ffb3cd', '', '', '236', '224')
call s:hi('TermCursorNC', '#3d2e34', '#3f2f34', '', '', '237', '237')
...
call s:hi('cssBraces', '#cbbec2', '', '', '', '251', '')
...
call s:hi('markdownHeadingRule', '#8b747c', '', '', '', '244', '')
