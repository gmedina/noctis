...
call s:hi('Normal', '#b2cacd', '#052529', '', '')
call s:hi('ColorColumn', '', '#29484c', '', '')
call s:hi('Conceal', '#49ace9', '', '', '')
call s:hi('Cursor', '#052529', '#85efff', '', '')
call s:hi('CursorColumn', '', '#083b42', '', '')
call s:hi('CursorLine', '', '#083b42', '', '')
call s:hi('CursorLineNr', '#169fb1', '#083b42', '', 'bold')
call s:hi('Directory', '#49d6e9', '', '', '')
call s:hi('EndOfBuffer', '#052529', '#052529', '', '')
call s:hi('ErrorMsg', '#e34e1c', '#052529', '', 'bold')
call s:hi('FoldColumn', '#5b858b', '#041d20', '', '')
call s:hi('Folded', '#5b858b', '#041d20', '', 'italic')
call s:hi('IncSearch', '#052529', '#40bf6a', '', 'bold')
call s:hi('LineNr', '#4e6b6e', '#052529', '', '')
call s:hi('MatchParen', '#169fb1', '#07353b', '', 'bold')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold')
call s:hi('MoreMsg', '#49e9a6', '', '', '')
call s:hi('NonText', '#254145', '', '', '')
call s:hi('Pmenu', '#87a7ab', '#073940', '', '')
call s:hi('PmenuSbar', '', '#041d20', '', '')
call s:hi('PmenuSel', '#b2cacd', '#0e6671', '', 'bold')
call s:hi('PmenuThumb', '', '#169fb1', '', '')
call s:hi('Question', '#49e9a6', '', '', '')
call s:hi('QuickFixLine', '', '#09444b', '', 'bold')
call s:hi('Search', '#b2cacd', '#09444b', '', '')
call s:hi('SignColumn', '#5b858b', '#052529', '', '')
call s:hi('SpecialKey', '#254145', '', '', '')
...
call s:hi('StatusLine', '#40d4e7', '#0a474f', '', 'bold')
call s:hi('StatusLineNC', '#87a7ab', '#041d20', '', '')
call s:hi('StatusLineTerm', '#40d4e7', '#0a474f', '', 'bold')
call s:hi('StatusLineTermNC', '#87a7ab', '#041d20', '', '')
call s:hi('TabLine', '#87a7ab', '#062e32', '', '')
call s:hi('TabLineFill', '', '#062e32', '', '')
call s:hi('TabLineSel', '#40d4e7', '#052529', '', 'bold')
call s:hi('Title', '#49d6e9', '', '', 'bold')
call s:hi('VertSplit', '#0f1415', '#052529', '', '')
call s:hi('Visual', '', '#0a464d', '', '')
call s:hi('VisualNOS', '', '#0a464d', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#052529', '#169fb1', '', 'bold')
call s:hi('WinSeparator', '#0f1415', '#052529', '', '')
...
call s:hi('Error', '#e34e1c', '#052529', '', 'bold')
call s:hi('Todo', '#052529', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#1b443b', '', '')
call s:hi('DiffChange', '#e0c184', '#283e38', '', '')
call s:hi('DiffDelete', '#e34e1c', '#292c27', '', '')
call s:hi('DiffText', '#e0c184', '#425142', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#052529', '', '')
call s:hi('GitGutterChange', '#e0c184', '#052529', '', '')
call s:hi('GitGutterDelete', '#e34e1c', '#052529', '', '')
