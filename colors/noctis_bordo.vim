...
call s:hi('Normal', '#cbbec2', '#322a2d', '', '')
call s:hi('ColorColumn', '', '#593a46', '', '')
call s:hi('Conceal', '#49ace9', '', '', '')
call s:hi('Cursor', '#322a2d', '#ffb3cd', '', '')
call s:hi('CursorColumn', '', '#3f2f34', '', '')
call s:hi('CursorLine', '', '#3f2f34', '', '')
call s:hi('CursorLineNr', '#bb778f', '#3f2f34', '', 'bold')
call s:hi('Directory', '#49d6e9', '', '', '')
call s:hi('EndOfBuffer', '#322a2d', '#322a2d', '', '')
call s:hi('ErrorMsg', '#e34e1c', '#322a2d', '', 'bold')
call s:hi('FoldColumn', '#8b747c', '#2c2528', '', '')
call s:hi('Folded', '#8b747c', '#2c2528', '', 'italic')
call s:hi('IncSearch', '#322a2d', '#40bf6a', '', 'bold')
call s:hi('LineNr', '#715b63', '#322a2d', '', '')
call s:hi('MatchParen', '#997582', '#403438', '', 'bold')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold')
call s:hi('MoreMsg', '#49e9a6', '', '', '')
call s:hi('NonText', '#4d3f44', '', '', '')
call s:hi('Pmenu', '#bbaab0', '#413036', '', '')
call s:hi('PmenuSbar', '', '#2c2528', '', '')
call s:hi('PmenuSel', '#cbbec2', '#563440', '', 'bold')
call s:hi('PmenuThumb', '', '#997582', '', '')
call s:hi('Question', '#49e9a6', '', '', '')
call s:hi('QuickFixLine', '', '#21464d', '', 'bold')
call s:hi('Search', '#cbbec2', '#21464d', '', '')
call s:hi('SignColumn', '#8b747c', '#322a2d', '', '')
call s:hi('SpecialKey', '#4d3f44', '', '', '')
...
call s:hi('StatusLine', '#f18eb0', '#5d3f49', '', 'bold')
call s:hi('StatusLineNC', '#a48e96', '#322a2d', '', '')
call s:hi('StatusLineTerm', '#f18eb0', '#5d3f49', '', 'bold')
call s:hi('StatusLineTermNC', '#a48e96', '#322a2d', '', '')
call s:hi('TabLine', '#bbaab0', '#413036', '', '')
call s:hi('TabLineFill', '', '#413036', '', '')
call s:hi('TabLineSel', '#f18eb0', '#322a2d', '', 'bold')
call s:hi('Title', '#49d6e9', '', '', 'bold')
call s:hi('VertSplit', '#1f191b', '#322a2d', '', '')
call s:hi('Visual', '', '#544349', '', '')
call s:hi('VisualNOS', '', '#544349', '', '')
call s:hi('WarningMsg', '#e69533', '', '', 'bold')
call s:hi('WildMenu', '#322a2d', '#997582', '', 'bold')
call s:hi('WinSeparator', '#1f191b', '#322a2d', '', '')
call s:hi('Comment', '#8b747c', '', '', 'italic')
...
call s:hi('Delimiter', '#cbbec2', '', '', '')
call s:hi('SpecialComment', '#8b747c', '', '', 'bold,italic')
call s:hi('Debug', '#e3541c', '', '', '')
call s:hi('Underlined', '#49ace9', '', '', 'underline')
call s:hi('Ignore', '#8b747c', '', '', '')
call s:hi('Error', '#e34e1c', '#322a2d', '', 'bold')
call s:hi('Todo', '#322a2d', '#e69533', '', 'bold')
call s:hi('DiffAdd', '#8ce99a', '#40493e', '', '')
call s:hi('DiffChange', '#ffc180', '#53423a', '', '')
call s:hi('DiffDelete', '#e34e1c', '#4e302a', '', '')
call s:hi('DiffText', '#ffc180', '#6b5444', '', 'bold')
call s:hi('GitGutterAdd', '#8ce99a', '#322a2d', '', '')
call s:hi('GitGutterChange', '#ffc180', '#322a2d', '', '')
call s:hi('GitGutterDelete', '#e34e1c', '#322a2d', '', '')
...
call s:hi('markdownHeadingRule', '#8b747c', '', '', '')
