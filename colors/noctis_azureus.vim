...
call s:hi('Normal', '#becfda', '#07273b', '', '', '252', '235')
call s:hi('ColorColumn', '', '#1a425b', '', '', '', '23')
call s:hi('Conceal', '#49ace9', '', '', '', '75', '')
call s:hi('Cursor', '#07273b', '#b3e2ff', '', '', '235', '195')
call s:hi('lCursor', '#07273b', '#b3e2ff', '', '', '235', '195')
call s:hi('CursorIM', '#07273b', '#b3e2ff', '', '', '235', '195')
call s:hi('CursorColumn', '', '#003b5e', '', '', '', '23')
call s:hi('CursorLine', '', '#003b5e', '', '', '', '23')
call s:hi('CursorLineNr', '#61a6d1', '#003b5e', '', 'bold', '74', '23')
call s:hi('CursorLineFold', '#61a6d1', '#003b5e', '', '', '74', '23')
call s:hi('CursorLineSign', '#61a6d1', '#003b5e', '', '', '74', '23')
call s:hi('Directory', '#49d6e9', '', '', '', '81', '')
call s:hi('EndOfBuffer', '#07273b', '#07273b', '', '', '235', '235')
call s:hi('ErrorMsg', '#e34e1c', '#07273b', '', 'bold', '202', '235')
call s:hi('FoldColumn', '#5988a6', '#062132', '', '', '73', '234')
call s:hi('Folded', '#5988a6', '#062132', '', 'italic', '73', '234')
call s:hi('IncSearch', '#07273b', '#40bf6a', '', 'bold', '235', '77')
call s:hi('LineNr', '#4d6c80', '#07273b', '', '', '60', '235')
call s:hi('MatchParen', '#1679b6', '#09324b', '', 'bold', '32', '236')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold', '85', '')
call s:hi('MoreMsg', '#49e9a6', '', '', '', '85', '')
call s:hi('NonText', '#274354', '', '', '', '238', '')
call s:hi('Pmenu', '#9fb6c6', '#09334e', '', '', '249', '23')
call s:hi('PmenuSbar', '', '#062132', '', '', '', '234')
call s:hi('PmenuSel', '#becfda', '#0c3f5f', '', 'bold', '252', '23')
call s:hi('PmenuThumb', '', '#1679b6', '', '', '', '32')
call s:hi('Question', '#49e9a6', '', '', '', '85', '')
call s:hi('QuickFixLine', '', '#0a4555', '', 'bold', '', '23')
call s:hi('Search', '#becfda', '#0a4555', '', '', '252', '23')
call s:hi('SignColumn', '#5988a6', '#07273b', '', '', '73', '235')
call s:hi('SpecialKey', '#274354', '', '', '', '238', '')
...
call s:hi('StatusLine', '#49ace9', '#05456e', '', 'bold', '75', '23')
call s:hi('StatusLineNC', '#879dab', '#07273b', '', '', '247', '235')
call s:hi('StatusLineTerm', '#49ace9', '#05456e', '', 'bold', '75', '23')
call s:hi('StatusLineTermNC', '#879dab', '#07273b', '', '', '247', '235')
call s:hi('TabLine', '#9fb6c6', '#09334e', '', '', '249', '23')
call s:hi('TabLineFill', '', '#09334e', '', '', '', '23')
call s:hi('TabLineSel', '#49ace9', '#07273b', '', 'bold', '75', '235')
call s:hi('Title', '#49d6e9', '', '', 'bold', '81', '')
call s:hi('VertSplit', '#0f1315', '#07273b', '', '', '233', '235')
call s:hi('Visual', '', '#0c4264', '', '', '', '23')
call s:hi('VisualNOS', '', '#0c4264', '', '', '', '23')
call s:hi('WarningMsg', '#e69533', '', '', 'bold', '215', '')
call s:hi('WildMenu', '#07273b', '#1679b6', '', 'bold', '235', '32')
call s:hi('WinSeparator', '#0f1315', '#07273b', '', '', '233', '235')
call s:hi('Comment', '#5988a6', '', '', 'italic', '73', '')
...
call s:hi('Delimiter', '#becfda', '', '', '', '252', '')
call s:hi('SpecialComment', '#5988a6', '', '', 'bold,italic', '73', '')
call s:hi('Debug', '#e3541c', '', '', '', '202', '')
call s:hi('Underlined', '#49ace9', '', '', 'underline', '75', '')
call s:hi('Ignore', '#5988a6', '', '', '', '73', '')
call s:hi('Error', '#e34e1c', '#07273b', '', 'bold', '202', '235')
call s:hi('Todo', '#07273b', '#e69533', '', 'bold', '235', '215')
call s:hi('DiffAdd', '#8ce99a', '#1c464a', '', '', '157', '237')
call s:hi('DiffChange', '#ffc180', '#2f4046', '', '', '222', '237')
call s:hi('DiffDelete', '#e34e1c', '#2a2d36', '', '', '202', '236')
call s:hi('DiffText', '#ffc180', '#4c524e', '', 'bold', '222', '239')
call s:hi('GitGutterAdd', '#8ce99a', '#07273b', '', '', '157', '235')
call s:hi('GitGutterChange', '#ffc180', '#07273b', '', '', '222', '235')
call s:hi('GitGutterDelete', '#e34e1c', '#07273b', '', '', '202', '235')
call s:hi('TermCursor', '#07273b', '#b3e2ff', '', '', '235', '195')
call s:hi('TermCursorNC', '#003c61', '#003b5e', '', '', '23', '23')
call s:hi('DiagnosticError', '#e34e1c', '', '', '', '202', '')
call s:hi('DiagnosticWarn', '#e69533', '', '', '', '215', '')
call s:hi('DiagnosticInfo', '#49ace9', '', '', '', '75', '')
...
call s:hi('cssBraces', '#becfda', '', '', '', '252', '')
...
call s:hi('markdownHeadingRule', '#5988a6', '', '', '', '73', '')
