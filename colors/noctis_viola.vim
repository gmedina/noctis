...
let g:colors_name = 'noctis_viola'
set background=dark
...
let s:terminal_ansi_colors = ['#362f3d','#e66533','#49e9a6','#e4b781','#49ace9','#df769b','#49d6e9','#bfafcf','#594e65','#e97749','#60ebb1','#e69533','#60b6eb','#e798b3','#60dbeb','#ccbfd9']
if has('nvim')
...
call s:hi('Normal', '#ccbfd9', '#30243d', '', '', '252', '236')
call s:hi('ColorColumn', '', '#473856', '', '', '', '238')
call s:hi('Conceal', '#49ace9', '', '', '', '75', '')
call s:hi('Cursor', '#30243d', '#d9b3ff', '', '', '236', '225')
call s:hi('lCursor', '#30243d', '#d9b3ff', '', '', '236', '225')
call s:hi('CursorIM', '#30243d', '#d9b3ff', '', '', '236', '225')
call s:hi('CursorColumn', '', '#3f2c52', '', '', '', '238')
call s:hi('CursorLine', '', '#3f2c52', '', '', '', '238')
call s:hi('CursorLineNr', '#996bc7', '#3f2c52', '', 'bold', '134', '238')
call s:hi('CursorLineFold', '#996bc7', '#3f2c52', '', '', '134', '238')
call s:hi('CursorLineSign', '#996bc7', '#3f2c52', '', '', '134', '238')
call s:hi('Directory', '#49d6e9', '', '', '', '81', '')
call s:hi('EndOfBuffer', '#30243d', '#30243d', '', '', '236', '236')
call s:hi('ErrorMsg', '#e34e1c', '#30243d', '', 'bold', '202', '236')
call s:hi('FoldColumn', '#7f659a', '#2b2136', '', '', '97', '236')
call s:hi('Folded', '#7f659a', '#2b2136', '', 'italic', '97', '236')
call s:hi('IncSearch', '#30243d', '#40bf6a', '', 'bold', '236', '77')
call s:hi('LineNr', '#665973', '#30243d', '', '', '241', '236')
call s:hi('MatchParen', '#8767a8', '#3c2d4b', '', 'bold', '133', '237')
call s:hi('ModeMsg', '#49e9a6', '', '', 'bold', '85', '')
call s:hi('MoreMsg', '#49e9a6', '', '', '', '85', '')
call s:hi('NonText', '#4b4056', '', '', '', '239', '')
call s:hi('Pmenu', '#b3a5c0', '#3d2e4d', '', '', '249', '237')
call s:hi('PmenuSbar', '', '#2b2136', '', '', '', '236')
call s:hi('PmenuSel', '#ccbfd9', '#593a78', '', 'bold', '252', '60')
call s:hi('PmenuThumb', '', '#8767a8', '', '', '', '133')
call s:hi('Question', '#49e9a6', '', '', '', '85', '')
call s:hi('QuickFixLine', '', '#204356', '', 'bold', '', '237')
call s:hi('Search', '#ccbfd9', '#204356', '', '', '252', '237')
call s:hi('SignColumn', '#7f659a', '#30243d', '', '', '97', '236')
call s:hi('SpecialKey', '#4b4056', '', '', '', '239', '')
call s:hi('SpellBad', '', '', '#e34e1c', 'undercurl', '', '')
call s:hi('SpellCap', '', '', '#bf8ef1', 'undercurl', '', '')
call s:hi('SpellLocal', '', '', '#49ace9', 'undercurl', '', '')
call s:hi('SpellRare', '', '', '#e69533', 'undercurl', '', '')
call s:hi('StatusLine', '#bf8ef1', '#54396f', '', 'bold', '183', '240')
call s:hi('StatusLineNC', '#9987ab', '#30243d', '', '', '247', '236')
call s:hi('StatusLineTerm', '#bf8ef1', '#54396f', '', 'bold', '183', '240')
call s:hi('StatusLineTermNC', '#9987ab', '#30243d', '', '', '247', '236')
call s:hi('TabLine', '#b3a5c0', '#3d2e4d', '', '', '249', '237')
call s:hi('TabLineFill', '', '#3d2e4d', '', '', '', '237')
call s:hi('TabLineSel', '#bf8ef1', '#30243d', '', 'bold', '183', '236')
call s:hi('Title', '#49d6e9', '', '', 'bold', '81', '')
call s:hi('VertSplit', '#1c1226', '#30243d', '', '', '234', '236')
call s:hi('Visual', '', '#4d3a61', '', '', '', '239')
call s:hi('VisualNOS', '', '#4d3a61', '', '', '', '239')
call s:hi('WarningMsg', '#e69533', '', '', 'bold', '215', '')
call s:hi('WildMenu', '#30243d', '#8767a8', '', 'bold', '236', '133')
call s:hi('WinSeparator', '#1c1226', '#30243d', '', '', '234', '236')
call s:hi('Comment', '#7f659a', '', '', 'italic', '97', '')
...
call s:hi('Delimiter', '#ccbfd9', '', '', '', '252', '')
call s:hi('SpecialComment', '#7f659a', '', '', 'bold,italic', '97', '')
call s:hi('Debug', '#e3541c', '', '', '', '202', '')
call s:hi('Underlined', '#49ace9', '', '', 'underline', '75', '')
call s:hi('Ignore', '#7f659a', '', '', '', '97', '')
call s:hi('Error', '#e34e1c', '#30243d', '', 'bold', '202', '236')
call s:hi('Todo', '#30243d', '#e69533', '', 'bold', '236', '215')
call s:hi('DiffAdd', '#8ce99a', '#3f444c', '', '', '157', '238')
call s:hi('DiffChange', '#ffc180', '#513d48', '', '', '222', '238')
call s:hi('DiffDelete', '#e34e1c', '#4d2b38', '', '', '202', '237')
call s:hi('DiffText', '#ffc180', '#6a5050', '', 'bold', '222', '240')
call s:hi('GitGutterAdd', '#8ce99a', '#30243d', '', '', '157', '236')
call s:hi('GitGutterChange', '#ffc180', '#30243d', '', '', '222', '236')
call s:hi('GitGutterDelete', '#e34e1c', '#30243d', '', '', '202', '236')
call s:hi('TermCursor', '#30243d', '#d9b3ff', '', '', '236', '225')
call s:hi('TermCursorNC', '#402d53', '#3f2c52', '', '', '238', '238')
call s:hi('DiagnosticError', '#e34e1c', '', '', '', '202', '')
call s:hi('DiagnosticWarn', '#e69533', '', '', '', '215', '')
call s:hi('DiagnosticInfo', '#bf8ef1', '', '', '', '183', '')
...
call s:hi('DiagnosticUnderlineInfo', '', '', '#bf8ef1', 'undercurl', '', '')
...
call s:hi('cssBraces', '#ccbfd9', '', '', '', '252', '')
...
call s:hi('markdownHeadingRule', '#7f659a', '', '', '', '97', '')
